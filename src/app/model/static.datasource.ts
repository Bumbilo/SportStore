...
export class StaticDataSource {
  private product: Product[] = [
    ...
    new Product(16, 'Product 16', 'Category 16', 'Product 16 (Category 16)', 100),
    new Product(17, 'Product 17', 'Category 17', 'Product 17 (Category 17)', 100),
    new Product(18, 'Product 18', 'Category 18', 'Product 18 (Category 18)', 100),
    new Product(19, 'Product 19', 'Category 19', 'Product 19 (Category 19)', 100),
  ];
